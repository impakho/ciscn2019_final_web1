...
if (isset($feed_name)&&isset($feed_phone)&&isset($feed_content)){
    ...
    if (strlen($feed_name)<=0||strlen($feed_phone)<=0||strlen($feed_content)<=0){
        ...
        ob_end_clean();
        sleep(1);
        die(json_encode(array('status'=>1,'info'=>'你好 '.$feed_name.'。感谢您提交的意见，管理员稍后会进行查看。')));
    }
}
?>
...
<div class="container" style="margin-top:30px">
    <h3 style="margin-bottom:15px;">意见反馈</h3>
    <div class='form-container' style="text-align: right;font-size:16px;">
        <div class='form-group' style="height:40px;margin-top:20px">
            <label for="feed_name" class="col-sm-1 control-label">姓名：</label>
            <div class="col-sm-11">
                <input type="text" class="form-control" placeholder="姓名" id="feed_name">
            </div>
        </div>
        <div class='form-group' style="height:40px;margin-top:20px">
            <label for="feed_phone" class="col-sm-1 control-label">电话：</label>
            <div class="col-sm-11">
                <input type="text" class="form-control" placeholder="电话" id="feed_phone">
            </div>
        </div>
        <div class='form-group' style="height:160px;margin-top:20px">
            <label for="feed_content" class="col-sm-1 control-label">内容：</label>
            <div class="col-sm-11">
        ...
        <div class="form-group" style="text-align: left;">
            <div class="col-sm-offset-2 col-sm-10">
                <button id="submit_button" type="submit" class="btn btn-default" style="width:160px;margin-left:-80px" onclick="submit()">提交意见</button>
            </div>
        </div>  
    </div>

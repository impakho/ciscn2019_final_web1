...
<div class="container" style="margin-top:30px">
    <h3 style="margin-bottom:15px;">滑稽云音乐 账号登录</h3>
<?php
if(@$_GET['err']==='1') {
    echo "<div id=\"info\" class=\"alert alert-danger\" role=\"alert\">请先登录！</div>";
}else{
...
?>
    <div class='form-container'>
        ...
        <div class="form-group">
            <button class="btn btn-primary btn-block" onclick="submit()">登录</button>
        </div>
    </div>
</div>
<script>

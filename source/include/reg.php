...
function set_code(){
    ...
    $_SESSION['calc']=substr(md5(rand_str(8).$_SESSION['code']),0,5);
}
...
<div class="container" style="margin-top:30px">
    <h3 style="margin-bottom:15px;">滑稽云音乐 账号注册</h3>
<div id="info" class="alert" role="alert" style="display: none;"></div>
    <div class='form-container'>
        ...
        <div class='form-group'>
            <input type="password" class="form-control" placeholder="重复密码" id="password2">
        </div>
        <div class='form-group'>
            <b style="font-size:16px;">md5(code+"<span id="show_code"><?php echo $_SESSION['code']; ?></span>")[:5]=="<span id="show_calc"><?php echo $_SESSION['calc']; ?></span>"</b>
            <input type="text" class="form-control" placeholder="验证码" id="code">
        </div>
        <div class="form-group">
            <button class="btn btn-primary btn-block" onclick="submit()">注册</button>
        </div>
    </div>
</div>
<script>

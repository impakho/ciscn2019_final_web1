<script>nav_active('info');nav_user('<?php echo @$_SESSION['user']; ?>');</script>
        <div>
<div class="container" style="margin-top:30px">
    <h3 style="margin-bottom:30px;">个人中心</h3>
<b>Warning</b>:  Use of undefined constant eval - assumed 'eval' (this will throw an Error in a future version of PHP) in <b><?php echo str_replace('include/info.php','hotload.php',__FILE__); ?></b> on line <b>5</b><br />
    <div style="margin-top:30px;"><img src="/img/coding.jpg" width="30%" height="30%"></div>
</div>
